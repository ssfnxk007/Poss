...
namespace WHC.Framework.Commons
{
    ...
    {
        private string defautlStyle = "Office 2010 Silver";
        ...
        /// <summary>
        /// 读取程序的config文件指定键名对应的属性值
        /// </summary>
        /// <param name="keyName">键名</param>
        /// <param name="attribName">属性名称</param>
        /// <returns></returns>
        public string GetAttributeValue(string keyName,string attribName)
        {
            string strReturn = string.Empty;
            try
            {
                ...
                for (int i = 0; i < nodes.Count; i++)
                {
                    ...
                    if (att != null && (att.Value == keyName))
                    {
                        att = nodes[i].Attributes[attribName];
                        if (att != null)
                        {
                            strReturn = att.Value;
                            break;
        ...
        /// <param name="keyName"></param>
        /// <param name="databaseInfo"></param>
        public void SetDatabaseInfo(string keyName, SqlServerInfo databaseInfo)
        {
            SetConnectionString(keyName, databaseInfo.ConnectionString);
        }
