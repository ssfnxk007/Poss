...
internal class ColorTable
{
    ...
    public static Color QQHighLightColor = Color.FromArgb(110,205,253);   //RenderHelper.GetColor(QQBorderColor, 255, -63, -11, 23);   //Color.FromArgb(110, 205, 253)
    public static Color QQHighLightInnerColor = Color.FromArgb(73, 172, 231);//RenderHelper.GetColor(QQBorderColor, 255, -100, -44, 1);   //Color.FromArgb(73, 172, 231);
}
