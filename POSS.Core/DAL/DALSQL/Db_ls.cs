...
namespace POSS.DALSQL
{
    ...
    /// Db_ls
    /// </summary>
	public class Db_ls : BaseDALSQL<Db_lsInfo>, IDb_ls
	{
		#region 对象实例及构造函数

		public static Db_ls Instance
		{
			get
			{
				return new Db_ls();
		...
		protected override Db_lsInfo DataReaderToEntity(IDataReader dataReader)
		{
			Db_lsInfo info = new Db_lsInfo();
        ...
        protected override Hashtable GetHashByEntity(Db_lsInfo obj)
		{
		    Db_lsInfo info = obj as Db_lsInfo;
